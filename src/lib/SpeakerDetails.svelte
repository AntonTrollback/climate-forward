  ...
  <div class="details">
    ...
    <figure>
      ...
      {#if speaker.data.image?.url}
        <img
          sizes="12.7rem"
          srcset="{src('w_203/f_auto,q_90', speaker.data.image.url)} 203w,{src(
            'w_406/f_auto,q_90',
            speaker.data.image.url
          )} 406w,{src('w_609/f_auto,q_90', speaker.data.image.url)} 609w"
          src={src('w_609/f_auto,q_90', speaker.data.image.url)}
          width={speaker.data.image.dimensions.width}
          height={speaker.data.image.dimensions.height}
          alt="Portrait of {asText(speaker.data.name)}" />
        {#if imageLink}
